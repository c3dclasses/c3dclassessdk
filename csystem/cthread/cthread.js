...
var CThread = new Class ({	
	...
	start : function() {
		if(this.m_iintervalid=setInterval(this.run.bind(this),this.m_iintervalms)<=-1)
			return null;
		this.m_creturn = _return_busy(null);
