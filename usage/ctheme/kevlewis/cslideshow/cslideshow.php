...
class CSlideShow extends CContent{
	...
	public function init(){
		$ccontrols = $this->getCWidgetInstance()->getControls();
		$width = $ccontrols->option("width");
		$height = $ccontrols->option("height");
...
SCRIPT;
	...
	public function admin_body(){
		$cwi = $this->getCWidgetInstance();	
		echo "<p>";
		echo $cwi->label("Category ID: ", "catid");	// get the catgories as a list
		echo $cwi->text("catid", "");
		echo "</p>";
		echo "<p>";
		echo $cwi->label("Width", "width");
		echo $cwi->text("width", "");
		echo "</p>";
		echo "<p>";
		echo $cwi->label("Height", "height");
		echo $cwi->text("height", "");
		echo "</p>";	
	} // end admin_body()
} // end CSlideShow
