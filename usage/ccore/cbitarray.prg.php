<?php
//---------------------------------------------------------------------------
// name: cbitarray.prg.php
// desc: demonstrates how to construct and use a bitarray object
//---------------------------------------------------------------------------

// includes
include_program( "CBitArrayProgram" );

//---------------------------------------------------
// name: CBitArrayProgram
// desc: hello world program
//---------------------------------------------------
class CBitArrayProgram extends CProgram{
	public function CBitArrayProgram(){ 
		parent :: CProgram();	
